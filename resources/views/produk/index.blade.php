                ...
                <div class="flex mt-5 md:mt-0 space-x-4">
                    <div class="relative">
                        ...
                        <div
                            ...
                            <img id="arrow-down" class="h-4 w-4" src="{{ asset('front/images/filter-down-arrow.svg') }}"
                                alt="filter arrow">
                            <img id="arrow-up" class="h-4 w-4 hidden" src="{{ asset('front/images/filter-up-arrow.svg') }}"
                                alt="filter arrow">
                        </div>
                    </div>
                </div>
